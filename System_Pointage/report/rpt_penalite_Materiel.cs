...
{
    public partial class rpt_penalite_Materiel : DevExpress.XtraReports.UI.XtraReport
    {
        public rpt_penalite_Materiel()
        {
            InitializeComponent();
            BindData();
        ...
        {
            cell_camion.DataBindings.Add("Text", this.DataSource, "camion");
